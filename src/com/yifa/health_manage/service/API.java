...
public class API {
	...
	public static String getblooddata(String msg,String userId) throws ClientProtocolException, IOException, JSONException {
		Map<String,String> map = new HashMap<String,String>();
    	map.put("matter.userId", userId);
    	map.put("matter.content", msg);
    	String json = httpPost(API_URL+"json.php",map);
    	JSONObject jsonObj = new JSONObject(json);
    	String  key = jsonObj.toString();
    	if(key.equals("0"))
    	{
...
/*    public static Page  getCommentList(String matterId,int pagenum) throws Exception
    ...
    public static ArrayList<Matter>  getMatterList(int page,String order) throws Exception
    {
    	...
    	//matterList = new Gson().fromJson(json, ArrayList<Matter>.class);
    	/*JSONObject jsonObj = new JSONObject(json);
...
*/	
	public static String httpPost(String url,Map<String,String> map,File file) throws ClientProtocolException, IOException
	{
         ...
         // 璁剧疆瀛楃闆�  
		 MultipartEntity mpEntity = new MultipartEntity(); //鏂囦欢浼犺緭
		 if(file!=null){
         ...
         System.out.println("url:"+url+"request params:--->>" + map.toString());
         // 鑾峰彇HttpClient瀵硅薄  
